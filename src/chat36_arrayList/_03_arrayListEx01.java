...
import homework.advance3.employee;
import homework.employee.Employee;
import homework.employee.TempEmployee;
			...
			while(true) {
				...
				switch(input) {
					case 1 : 
						...
						bonus = sc.nextInt();
						arraylist.add(new TempEmployee(eno, name, pay, input, hireYear));
					    arraylist.get(arraylist.size()-1).showEmployeeInfo();
						System.out.println("----------------");
						break;
					case 2 : 
						System.out.print("사번을 입력하세요.");
					...
					case 4 : 
						for(int i = 0; i < arraylist.size(); i++) {
							...
							arraylist.get(i).showEmployeeInfo();
							System.out.println("------------");
							}
