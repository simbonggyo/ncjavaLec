...
public class _05_LinkedList {
	...
	public static void main(String[] args) {
		...
		System.out.println("ArrayList에 순차적으로 데이터를"+"추가하는데 걸린시간:" + (endTime - startTime) + "나노초 입니다.");		
	...
	endTime = System.nanoTime();
	System.out.println("LinkedList에서 인덱스에"+"접근하는 데 걸린시간 :" + (endTime - startTime) + "나노초 입니다." );
	
	System.out.println("-------------------------------");
	
	
	
	System.out.println("LinkedList에 순차적으로 데이터를"+"추가하는데 걸린시간:" + (endTime - startTime) + "나노초 입니다.");		
	 ...
	 System.out.println("----------------------");
		...
		//contains 메소드 속도 비교
				...
				System.out.println("ArrayList 인덱스의 데이터를 "
				...
				System.out.println("LinkedList 인덱스의 데이터를 "
						+ "삭제하는 데 걸린시간 : " + (endTime - startTime) 
						+ "나노초입니다.");
